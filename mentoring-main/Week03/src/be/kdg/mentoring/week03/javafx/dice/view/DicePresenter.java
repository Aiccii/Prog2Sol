...
public class DicePresenter {
    ...
    private void setWindowsExitEvent() {
...
//            model.setNumberOfDice(model.getNumberOfDice() + 1);
//            view.getInfoLabel().setText(String.format("Total: %d. Number of dice is now %d", model.getTotalFaceValues(), model.getNumberOfDice()));
//            System.out.println(String.format("Updated number of dice to %d", model.getNumberOfDice()));
//            if(model.getNumberOfDice() != view.getDiceView().size()) {
//                view.updateNumberOfDice(model.getNumberOfDice());
//            }
